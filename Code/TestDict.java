public class TestDict {
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 0) for (i = 0; i < 11; ++i) test[i] = true;
        else {
            if (args[0].equals("help")) {
                System.out.println(
                    "Usage: java TestDict, or java TestDict n1 n2 n3 ... "
                );
                System.out.println(
                    "ni have value 1 - 10, only those tests will be run"
                );
                System.exit(0);
            }
        ...
        if (
            ...
            dict.put(new Data("XOXOXOXOXOXOXXX", 43));
            if (test[1]) System.out.println("   Test 1 succeeded " + dict.numRecords());
        ...
        if (test[2] || test[3] || test[6]) try {
            dict.put(new Data("answer", 56));
            if (test[2]) System.out.println("***Test 2 failed");
        } catch (DictionaryException e) {
            if (test[2]) System.out.println("   Test 2 succeeded " + dict.numRecords());
        }
        ...
        if (test[3]) try {
            ...
            if (dict.get("XOXOXOXOXOXOXXX") == -1) passed = false;
            if (!passed) System.out.println("***Test 3 failed");
            else System.out.println("   Test 3 succeeded " + dict.numRecords());
        } catch (Exception e) {
        ...
        if (test[4]) try {
            ...
            else System.out.println("   Test 4 succeeded " + dict.numRecords());
        } catch (Exception e) {
        ...
        if (test[5]) try {
            ...
            System.out.println("   Test 5 succeeded " + dict.numRecords());
        }
        ...
        if (test[7] || test[8] || test[9] || test[10]) try {
            for (i = 0; i < 10000; ++i) {
                s = Integer.toString(i);
                for (j = 0; j < 5; ++j) s += s;
                collisions += dict.put(new Data(s, i));
            }
            if (test[7]) System.out.println("   Test 7 succeeded " + dict.numRecords());
        } catch (DictionaryException e) {
        ...
        if (test[8]) {
            ...
            if (passed) System.out.println("   Test 8 succeeded " + dict.numRecords());
        }
        ...
        if (test[9]) try {
            ...
            if (passed) System.out.println("   Test 9 succeeded " + dict.numRecords());
        } catch (DictionaryException e) {
            System.out.println("***Test 9 failed");
        }

        //Test 10: Number of collisions
        if (test[10]) if (collisions >= 2800) {
